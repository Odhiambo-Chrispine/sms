...
SECRET_KEY = 'django-insecure-@mv9zhhk5xzq2e3rz7kx-5f364@p_=de#$ot2wp+iwlq-tphss'
...
DATABASES = {
    'default':dj_database_url.parse('postgres://sms_dq83_user:15pVUI3Rk3PdIMkWalJNdrFPetmaDPnK@dpg-co22jdn109ks73btfub0-a.ohio-postgres.render.com/sms_dq83')
}
