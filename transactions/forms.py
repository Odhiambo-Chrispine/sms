...
class SupplierForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['bank_account'].widget.attrs.update({'class': 'textinput form-control', 'maxlength': '16', 'title' : 'bank_account Format Required'})
    class Meta:
        model = Supplier
        fields = ['name', 'phone', 'address', 'email', 'bank_account']
        widgets = {
...
class SaleForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['email'].widget.attrs.update({'class': 'textinput form-control'})
        self.fields['bank_account'].widget.attrs.update({'class': 'textinput form-control', 'maxlength': '15', 'title' : 'bank_account Format Required'})
    class Meta:
        model = SaleBill
        fields = ['name', 'phone', 'address', 'email', 'bank_account']
        widgets = {
